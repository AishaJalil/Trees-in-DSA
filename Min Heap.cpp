...
public:
    ...
    void minHeapify(Node*& root) {
        ...
        if (parent != NULL && parent->data > smallest->data) {
            int temp = parent->data;
            parent->data = smallest->data;
            smallest->data = temp;
            minHeapify(parent);
        }
    }
    ...
    void Insert(int data) {
        ...
        if (temp->left->data == data) {
            minHeapify(temp->left);
        }
        else {
            minHeapify(temp->right);
        }
    }

    void delete_minHeap(Node*& root) {
        if (root == NULL) {
            return;
        }
